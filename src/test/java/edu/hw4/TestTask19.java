...
public class TestTask19 {
    ...
    private static Stream<Arguments> getNamesAndErrorsOfAnimalsWithErrors_ShouldReturnMap() {
        return Stream.of(
            ...
            Arguments.of(
                ...
                Map.of("Aarne", Set.of(ANIMAL_VALIDATOR.getAgeValidationError()))
            ),
            Arguments.of(
            ...
            Arguments.of(
                ...
                Map.of(
                    "Aarne", Set.of(ANIMAL_VALIDATOR.getHeightValidationError()),
                    "Bob", Set.of(
                        ANIMAL_VALIDATOR.getAgeValidationError(),
                        ANIMAL_VALIDATOR.getHeightValidationError(),
                        ANIMAL_VALIDATOR.getWeightValidationError()
                    )
                )
            )
        );
    ...
    void getNamesAndErrorsOfAnimalsWithErrors_ShouldReturnMap(
        List<Animal> animalList, Map<String, Set<ValidationError>> expectedMap
    ) {
        Map<String, Set<ValidationError>> actualMap = Task19.getNamesAndErrorsOfAnimalsWithErrors(animalList);
    ...
    void getNamesAndErrorsOfAnimalsWithErrors_ShouldThrowNullPointerException(List<Animal> animalList) {
        assertThatThrownBy(
            () -> Task19.getNamesAndErrorsOfAnimalsWithErrors(animalList)
